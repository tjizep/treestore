 ...
 * Copyright (C) 2013-2050 Christiaan Pretorius
 */
...
public:
    ...
    typedef btree_multimap<key_type, data_type, storage_type, key_compare, traits, allocator_type> self;
	...
	typedef stx::btree<key_type, data_type, storage_type, value_type, key_compare, traits, true, allocator_type> btree_impl;
...
public:
    ...
    /// comparison function
    explicit inline btree_multimap
...
public:
	...
	/// Set the max use of the tree before using to storage
